...
import { LeadDetailModel, LeadInboxItem } from "@/lib/server/read-models/leads";
...
export function LeadsWorkspace({ agencyId, inboxItems, selectedLeadId, leadDetail }: LeadsWorkspaceProps) {
  return (
